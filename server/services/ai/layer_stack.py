...
SKILLS: List[Dict[str, Any]] = [
    ...
    {"id": "pick_account", "label": "租账号", "owner": "test-engineer", "summary": "按场景租号", "intent": "persist", "category": "flow"},
    {"id": "goal-extract", "label": "抽取目标", "owner": "test-engineer", "summary": "开跑前抽出检查点", "intent": "act", "category": "device"},
    {"id": "inspect-session", "label": "观察登录会话", "owner": "test-engineer", "summary": "登录用例看图；业务用例前置登录后跳过", "intent": "act", "category": "device"},
    {"id": "case-scene", "label": "用例场景理解", "owner": "test-engineer", "summary": "开跑前判断登录闸门、设备和前置 kind，只出枚举", "intent": "act", "category": "device"},
